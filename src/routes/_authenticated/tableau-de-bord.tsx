  ...
  head: () => ({
    meta: [
      { title: "Accueil — COM ICC Le Mans" },
      {
        name: "description",
        content:
          "Accueil du pôle Communication ICC Le Mans : versets, accès aux modules et tableau de bord personnel.",
      },
      { property: "og:title", content: "Accueil — COM ICC Le Mans" },
      {
        property: "og:description",
        content: "Accès aux modules du pôle Communication et tableau de bord personnel.",
      },
