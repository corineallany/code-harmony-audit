...
function Trombinoscope() {
  ...
  return (
    <AppShell title="Trombinoscope" subtitle={`${rows.length} membre(s)`} actions={isAdmin ? <Button asChild size="sm"><Link to="/membre/$id" params={{ id: "nouveau" }}>+ Ajouter un membre</Link></Button> : undefined}>
      ...
      <div className="mb-5 grid gap-2 md:grid-cols-2 xl:grid-cols-5">
        ...
        <Filter value={role} onChange={setRole} items={[["all","Tous les rôles"],["referent","Référent"],["equipier","Équipier"]]} />
