  ...
  return (
    <AppShell title="Mon profil" subtitle={role ? ROLE_LABEL[role] : "Sans rôle attribué"}>
      <Tabs defaultValue="profil">
        ...
        <TabsContent value="formation"><Card><CardHeader><CardTitle className="text-base">Mon parcours de formation</CardTitle></CardHeader><CardContent className="space-y-1 text-sm"><p><b>Statut :</b> {member.training_done ? "Formation terminée" : "En formation"}</p></CardContent></Card></TabsContent>
